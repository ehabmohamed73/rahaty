  ...
  return (
    <div className="relative" ref={name === openDropdown ? dropdownRef : null}>
      <button
        ...
        className="w-full px-4 py-2.5 text-[10px] sm:text-sm border border-gray-300 rounded-lg bg-white text-right flex items-center justify-between hover:border-gray-400 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      >
        <ChevronDown
